...
MIDDLEWARE_CLASSES = [
    'redirects.middleware.RedirectHashCompatMiddleware',
    ...
    'crawlable.middleware.HashbangMiddleware',
...
FLUENT_DASHBOARD_APP_GROUPS = (
    ...
    # The '*' selector acts like a fallback for all other  This section mainly displays models
