...
from cowry.adapters import AbstractPaymentAdapter
from cowry.models import PaymentStatuses, PaymentLogLevels
from cowry_docdata.adapters import docdata_payment_logger
from cowry_docdata.models import DocDataPayment
