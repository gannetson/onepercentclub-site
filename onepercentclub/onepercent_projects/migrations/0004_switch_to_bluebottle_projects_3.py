...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OnePercentProject.pitch'
        ...
        # Adding field 'OnePercentProject.theme'
        ...
        # Adding field 'OnePercentProject.country'
    ...
    def backwards(self, orm):
        # Deleting field 'OnePercentProject.pitch'
        #db.delete_column('projects_project', 'pitch')

        # Deleting field 'OnePercentProject.status'
        db.delete_column('projects_project', 'status_id')

        # Deleting field 'OnePercentProject.theme'
        db.delete_column('projects_project', 'theme_id')

        # Deleting field 'OnePercentProject.favorite'
        db.delete_column('projects_project', 'favorite')

        # Deleting field 'OnePercentProject.description'
        db.delete_column('projects_project', 'description')

        # Deleting field 'OnePercentProject.image'
        db.delete_column('projects_project', 'image')

        # Deleting field 'OnePercentProject.organization'
        db.delete_column('projects_project', 'organization_id')

        # Deleting field 'OnePercentProject.country'
        db.delete_column('projects_project', 'country_id')
