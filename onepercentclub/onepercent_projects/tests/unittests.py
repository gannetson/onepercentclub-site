...
from wallposts.models import TextWallPost
from fund.models import DonationStatuses, Donation, Order
from onepercent_projects.models import ProjectPlan, ProjectCampaign
