...
from onepercent_projects.models import ProjectPitch, ProjectPlan, ProjectPhases, ProjectCampaign, ProjectTheme
from fund.models import Donation, DonationStatuses
from onepercent_projects.serializers import (
    ProjectSupporterSerializer, ManageProjectSerializer, ManageProjectPitchSerializer,
    ManageProjectPlanSerializer, ProjectPlanSerializer, ProjectPitchSerializer,
    ProjectPreviewSerializer, ProjectCampaignSerializer, ProjectThemeSerializer)
from onepercent_projects.permissions import IsProjectOwner, NoRunningProjectsOrReadOnly, EditablePitchOrReadOnly, EditablePlanOrReadOnly
