import logging
import random
from vouchers.models import VoucherStatuses
...
from cowry.signals import payment_status_changed
...
class Donation(models.Model):
    ...
    project = models.ForeignKey('onepercent_projects.OnePercentProject', verbose_name=_("Project"))
...
def link_anonymous_donations(sender, user, request, **kwargs):
    ...
    from wallposts.models import SystemWallPost
